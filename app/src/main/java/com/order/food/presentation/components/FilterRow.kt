    ...
    Row(modifier = Modifier
        ...
        LazyRow(modifier = Modifier.weight(2f),
            ...
            items(filters) { filter->
                FilterChip(onClick = {selectedFilter = filter},
                    ...
                    leadingIcon = {
                        if (filter == "Filter"){
                            Icon(painter = painterResource(id = R.drawable.dining),
                            contentDescription = null,
                                tint = Color.Unspecified,
                                modifier = Modifier.size(16.dp))
                        }
                        if (filter == "Flash Sale"){
                            Icon(painter = painterResource(id = R.drawable.snack_meal),
                                contentDescription = null,
                                tint = Color.Unspecified,
                                modifier = Modifier.size(16.dp))
                        }
                        ...
                        if (filter == "Rating"){
                            Icon(painter = painterResource(id = R.drawable.rating),
                                contentDescription = null,
                                tint = Color.Unspecified,
                                modifier = Modifier.size(16.dp))
                        }
                        ...
                        if (filter == "Filter"){
                            Icon(painter = painterResource(id = R.drawable.arrowdown),
                                contentDescription = null,
                                tint = Color.Unspecified,
                    ...
                    enabled = true,
                    border = BorderStroke(0.4.dp, color = colorResource(R.color.gray))
                    )
            }
        }
